	...
	ckplayer.prototype = {
		...
		*/
		...
		loadAdPause: function() {
			...
			if (this.isStrImage(type) && this.adPauseShow) {
				...
				var imgHtml = '<img data-src="' + ad['file'] + '" class="' + imgClass + '">';
				if (ad['link']) {
		...
		*/
		...
		loadAdvertisements: function() {
			...
			if (ad['link']) {
				...
				var linkTemp = '<a href="' + ad['link'] + '" target="_blank" class="ckadmorelink"><img data-src="' + this.ckStyle['png-1-1'] + '" width="'+this.ckStyle['advertisement']['adLinkButton']['width']+'" height="'+this.ckStyle['advertisement']['adLinkButton']['height']+'"></a>';
		...
		*/
		newAdOther: function(i) {
			...
			var adHtml='<img data-src="' + ad['file'] + '" class="' + imgClassName + '">';
			if(ad['link']){
				...
				for (i = 0; i < list.length; i++) {
					...
					case 'gif':
						...
						if (clickEvent['type'] == 'link') {
							html += '<div class="' + newEleid + '" data-i="' + i + '"><a href="' + clickEvent['link'] + '" target="' + clickEvent['target'] + '"><img class="' + newEleid + '_image" data-src="' + list[i]['file'] + '" style="border:0;"></a></div>';
						} else {
							html += '<div class="' + newEleid + '" data-i="' + i + '"><img class="' + newEleid + '_image" data-src="' + list[i]['file'] + '" style="border:0;"></div>';
						}
						break;
					case 'text':
						textObj = {
